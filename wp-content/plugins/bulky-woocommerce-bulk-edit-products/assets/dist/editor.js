...
const _f = {
    ...
    sidebarNotice(text, color = '') {
        let content = $(`<div class="vi-wbe-notice vi-ui message ${color}" >${text}</div>`);
        $('.vi-wbe-sidebar-notice').html(content);
        ...
        _functions__WEBPACK_IMPORTED_MODULE_1__.default.ajax({
            ...
            success(res) {
                ...
                if (res.success) {
                    ...
                    _functions__WEBPACK_IMPORTED_MODULE_1__.default.sidebarNotice(res.data.message, 'red');
                }
            },
            error(res) {
                console.log(res)
